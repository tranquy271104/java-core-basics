...
* **Câu lệnh continue:** Khi gặp từ khóa này, vòng lặp sẽ bỏ qua toàn bộ các câu lệnh còn lại nằm phía dưới nó trong lượt lặp hiện tại, để lập tức nhảy sang một lượt lặp mới.
